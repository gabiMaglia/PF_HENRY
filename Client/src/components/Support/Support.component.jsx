...
const SupportComponent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(data, "despues el axios")

      if (data.success) {
        console.log(data, "antes del alert")
        Swal.fire({
          icon: "success",
          title: "Mensaje Enviado",
          text: "Responderemos a la brevedad.",
        });
        console.log(data, "despues del alert y antes del limpiado del form")
        setName("");
        setPhone("");
        setEmail("");
        setArea("");
        console.log(data, "despues del limpiado del form")
      } else {
        Swal.fire({
          icon: "error",
          title: "Oops...",
