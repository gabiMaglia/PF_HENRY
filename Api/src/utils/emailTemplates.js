    ...
    .sendMail({
      ...
      >
        <tr>
          <td>
            <a href="https://pf-henry-sepia.vercel.app/">
            <img src="https://res.cloudinary.com/hypermegared/image/upload/v1704925814/jwnogqatk0b1jdmpfrzz.png" alt="logo" style="width: 130px;height: 100px; margin: 0 200px 40px 200px ;">
            </a>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="text-align:start;text-align:center; margin-inline: auto;max-width: 300px;">
